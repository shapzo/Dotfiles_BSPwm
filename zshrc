...
# Quite el comentario de la siguiente línea para usar la finalización que distingue entre mayúsculas y minúsculas.
# CASE_SENSITIVE="true"
...
# Descomente la siguiente línea para habilitar la autocorrección de comandos.
